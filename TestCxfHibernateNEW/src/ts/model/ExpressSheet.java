...
//			sb.append("TransPackageContent.size=").append(getTransPackageContent().size()).append(" ");
	...
	public static final class STATUS{
		public static final int STATUS_CREATED = 0;     //0新建
		public static final int STATUS_TRANSPORT = 1;   //1转运
		public static final int STATUS_REACH = 2;       //2派送
		public static final int STATUS_DELIVERIED = 3;   //3交付
	}
}
