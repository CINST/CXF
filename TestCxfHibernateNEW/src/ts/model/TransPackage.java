...
public class TransPackage implements Serializable {
	...
	@OneToMany(mappedBy="smallPkg", targetEntity=TwoPackage.class)	
	@org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.DELETE})	
	@org.hibernate.annotations.LazyCollection(org.hibernate.annotations.LazyCollectionOption.TRUE)	
	private java.util.Set<TwoPackage> twoPackage = new java.util.HashSet<TwoPackage>();
	...
	*/
	...
	@Transient	
	private String sourceNodeString;
	public void setSourceNodeString(String value) {
		this.sourceNodeString = value;
	}
	
	public String getSourceNodeString() {
		return sourceNodeString;
	}
	
	
	@Transient	
	private String targetNodeString;
	public void setTargetNodeString(String value) {
		this.targetNodeString = value;
	}
	
	public String getTargetNodeString() {
	...
	public static final class STATUS{
		public static final int STATUS_CREATED = 0;     //0 新建
		public static final int STATUS_TRANSPORT = 1;   //1 打包完成
		public static final int STATUS_RECEIVED = 2;   //2 揽收货篮，即揽收人员的车
		public static final int STATUS_NODE = 3;   //3 该包裹是分拣中心或营业网点
		public static final int STATUS_CAR = 4;    //4 该包裹是某一转运司机的车
		public static final int STATUS_DELIVERIED = 5;   //5该包裹是某一派送员的车
	}
